...
export class SideBarMenu extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.expandedMenuItems = page.locator(".oxd-main-menu a.oxd-main-menu-item span");
  }
  ...
  private async clickTimeMenu(): Promise<void> {
    await this.element.clickElement(this.timeMenu, "clickTimeMenu", "time menu");
  }
  ...
  private async clickDashboardMenu(): Promise<void> {
    await this.element.clickElement(this.dashboardMenu, "clickDashboardMenu", "dashboard menu");
  }
  ...
  private async clickDirectoryMenu(): Promise<void> {
    await this.element.clickElement(this.directoryMenu, "clickDirectoryMenu", "directory menu");
  }
  ...
  private async clickClaimMenu(): Promise<void> {
    await this.element.clickElement(this.claimMenu, "clickClaimMenu", "claim menu");
  }
  ...
  private async clickBuzzMenu(): Promise<void> {
    await this.element.clickElement(this.buzzMenu, "clickBuzzMenu", "buzz menu");
  }
   ...
   */
  public async verifySidebarState(sideBarMenuState: SidebarMenuOptions): Promise<void> {
    await this.verifyCollapseSideMenuButtonIsVisible();
    await this.clickCollapseSideMenuButton();
    await this.verifyCollapsedLogoHiddenWhenSidebarExpanded();
    await this.verifySideMenuItemsBasedOnState(sideBarMenuState);
